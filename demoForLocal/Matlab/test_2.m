...
inputData = xlsread('E:\hetanjin\GithubFiles\DBGCWebapp\demoForLocal\Matlab\DBGCVectors\DBGCVectors.xlsx','inputVectors',['F' num2str(inputStartLine) ':FS' num2str(inputStartLine+sampleSize-1)]);    % 所有样本
...
load E:\hetanjin\GithubFiles\DBGCWebapp\demoForLocal\Matlab\savedNet\parameterizedAlgorithm_2 
